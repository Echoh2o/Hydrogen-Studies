    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden transition-all hover:shadow-md">
      <div className="h-40 overflow-hidden">
        <div className="w-full h-full bg-gradient-to-r from-neutral-200 to-neutral-300 relative">
          {category.icon && (
            <svg className="absolute inset-0 m-auto h-20 w-20 text-primary opacity-20" 
      ...
      <div className="p-6">
        <h3 className="font-heading font-bold text-xl mb-2 text-neutral-800">{category.name}</h3>
