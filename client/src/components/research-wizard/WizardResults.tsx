    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mb-4">
          Based on your selections, we've generated the following research
          suggestions
        </p>
          ...
          <Card key={index} className="overflow-hidden">
            ...
            <CardContent className="pt-4 pb-2">
              <div className="space-y-4">
                ...
                {suggestion.researchGaps &&
                  suggestion.researchGaps.length > 0 && (
                    <div>
                      <div className="flex items-center gap-2 text-primary mb-2">
                        <Sparkles size={18} />
                ...
                {suggestion.relatedStudies &&
                  suggestion.relatedStudies.length > 0 && (
                    <div>
                      <div className="flex items-center gap-2 text-primary mb-2">
                        <BookOpen size={18} />
                      ...
                      <div className="space-y-2">
                        ...
                        {suggestion.relatedStudies.length > 3 && (
                          ...
                          >
                            View {suggestion.relatedStudies.length - 3} more
                            related studies
                          </Button>
                        )}
                      </div>
