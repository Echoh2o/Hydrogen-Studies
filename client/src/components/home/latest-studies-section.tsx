    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-3xl font-bold font-heading text-neutral-900 mb-2">
              Latest Research
            </h2>
            <p className="text-neutral-600">
              Recently added studies to our database
            </p>
          </div>
          <Link
            href="/studies"
            className="text-primary font-medium hover:underline hidden md:inline-block"
          >
            View all research →
          </Link>
        </div>
