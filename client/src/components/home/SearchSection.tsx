      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-neutral-600 text-center mb-8">
            Find relevant research on hydrogen gas for health and medical
            applications
          </p>
                ...
                <div className="md:w-1/3">
                  ...
                  <Select value={category} onValueChange={setCategory}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="clinical-trials">
                        Clinical Trials
                      </SelectItem>
                    </SelectContent>
                  </Select>
                    ...
                    <div className="flex items-center h-full pt-6">
                      <label className="flex items-center cursor-pointer">
                        ...
                        <div className="h-6 w-6 border-2 border-neutral-300 rounded-md peer-checked:bg-primary peer-checked:border-primary relative">
                          {fullTextOnly && (
                            <div className="absolute text-white top-0 left-0 w-full h-full flex items-center justify-center">
                              ✓
                            </div>
                          )}
                        </div>
