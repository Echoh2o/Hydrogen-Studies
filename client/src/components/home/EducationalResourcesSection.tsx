    ...
    return (
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-2">Educational Resources</h2>
          <p className="text-neutral-600 text-center mb-8">Learn about hydrogen research and its applications</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-neutral-100 rounded-xl overflow-hidden shadow-sm animate-pulse">
    ...
    return (
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Educational Resources</h2>
          <p className="text-red-500">Error loading educational resources. Please try again later.</p>
        </div>
      </section>
    );
  }
