...
const CategoriesSection = () => {
  ...
  const getCategoryIconName = (categoryName: string) => {
    if (categoryName.includes("Brain") || categoryName.includes("Neurological"))
      return "brain";
    if (
      categoryName.includes("Heart") ||
      categoryName.includes("Cardiovascular")
    )
      return "heartbeat";
    if (categoryName.includes("Cancer") || categoryName.includes("Immune"))
      return "shield-virus";
    if (categoryName.includes("Diabetes") || categoryName.includes("Metabolic"))
      return "dna";
    if (categoryName.includes("Lung") || categoryName.includes("Respiratory"))
  ...
  const categories =
    (categoriesResponse as any)?.data?.condition?.map(
