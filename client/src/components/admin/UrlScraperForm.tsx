    ...
    try {
      ...
      if (response.success && response.study) {
        ...
        toast({
          ...
          description:
            "The study data was successfully extracted from the URL.",
        });
      } else {
        setError(
          response.message || "Failed to extract study data from the URL",
        );
      }
    } catch (err: any) {
      setError(
        err.message || "An error occurred while fetching the study data",
      );
      toast({
        variant: "destructive",
        title: "Error",
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Europe PMC API provides direct access to over 40 million
                  publications with enhanced metadata
                </p>
              </div>
            </div>
          </Form>
