  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Import studies from an Excel spreadsheet. The file should contain columns that match our database structure.
        </CardDescription>
      </CardHeader>
              ...
              <AlertDescription>
                {importResult.imported > 0 ? (
                  <div className="space-y-1">
                    <p>Successfully imported {importResult.imported} out of {importResult.total} studies.</p>
                  ...
                  <p>{importResult.message || "Failed to import studies from Excel file"}</p>
                )}
              </AlertDescription>
            </Alert>
          )}
