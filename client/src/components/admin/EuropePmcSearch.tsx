...
const EuropePmcSearch: React.FC = () => {
  ...
  const renderSearchResults = () => {
    ...
    if (!searchResults || !searchResults.data || !searchResults.data.resultList || !searchResults.data.resultList.result || searchResults.data.resultList.result.length === 0) {
      if (searchQuery) {
        return (
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center text-xs text-muted-foreground mb-2">
                ...
                {article.pubType && (
                  <>
                    <span className="mx-1">•</span>
                    <Badge variant="outline" size="sm">{article.pubType}</Badge>
                  </>
                )}
              </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-sm">
            ...
            <span>{article.journalInfo?.journal?.title || selectedArticle.journalTitle}</span>
          ...
          {article.fullTextUrlList?.fullTextUrl && article.fullTextUrlList.fullTextUrl.length > 0 && (
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {article.fullTextUrlList.fullTextUrl.map((url: any, index: number) => (
                  <a 
                    key={index}
                    href={url.url}
                    target="_blank"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {article.keywordList?.keyword?.map((keyword: string, index: number) => (
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Search over 40 million publications in Europe PMC and save them to your database
          </CardDescription>
        </CardHeader>
            ...
            <form onSubmit={form.handleSubmit(handleSearch)} className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Use AND, OR, NOT for boolean logic: hydrogen AND therapy</li>
                  <li>Use parentheses for complex queries: (hydrogen OR H2) AND therapy</li>
                  <li>Add a hydrogen-related term if you're searching for hydrogen studies</li>
                </ul>
              </div>
            </form>
          </Form>
