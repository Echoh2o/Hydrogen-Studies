...
import { HiSearch, HiFilter, HiSortAscending, HiSortDescending, HiBookmark, HiEye, HiDocument } from "react-icons/hi";
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2 max-h-64 overflow-y-auto">
                    {filterOptions.categories.slice(0, 10).map((category: any) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {['Clinical Trial', 'Meta-Analysis', 'Animal Study', 'In Vitro Study'].map((type) => (
