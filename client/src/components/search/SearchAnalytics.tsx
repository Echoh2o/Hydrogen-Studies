...
export const trackSearchEvent = (eventType: string, data: any) => {
  switch (eventType) {
    ...
    case 'search_suggestion_selected':
      trackEvent('search_suggestion', 'autocomplete', data.suggestion, data.position);
      break;
    ...
    case 'search_sort_changed':
      trackEvent('search_sort', 'user_preference', data.sortBy + '_' + data.sortOrder);
      break;
...
export const trackStudyInteraction = (action: string, studyId: number, studyTitle: string, additionalData?: any) => {
