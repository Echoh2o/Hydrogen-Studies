...
export default function ResearchTrendsChart({ className }: ResearchTrendsProps) {
      ...
      <Card className={className}>
        ...
        <CardContent>
          <div className="h-64 flex items-center justify-center">
            <div className="animate-pulse text-muted-foreground">Loading research trends...</div>
          </div>
        </CardContent>
      </Card>
    );
