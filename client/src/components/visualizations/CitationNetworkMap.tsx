...
export default function CitationNetworkMap({
  ...
  const mockNetworkData = {
    nodes: [
      ...
      {
        id: "6",
        title: "Hydrogen therapy in metabolic syndrome",
        citations: 156,
        category: "Metabolic",
        year: 2017,
      },
      {
        id: "7",
        title: "Anti-inflammatory properties of hydrogen gas",
        citations: 203,
        category: "Immune",
        year: 2013,
      },
      {
        id: "8",
        title: "Hydrogen water for skin health and aging",
        citations: 142,
      ...
      {
        id: "9",
        title: "Cardiac protection via hydrogen supplementation",
        citations: 187,
        category: "Cardiovascular",
        year: 2019,
      },
      {
        id: "10",
        title: "Hydrogen therapy in cancer treatment",
        citations: 165,
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {displayData.stats?.totalConnections ||
                displayData.links?.length ||
                0}
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {displayData.nodes
              ?.sort(
                (a: NetworkNode, b: NetworkNode) => b.citations - a.citations,
              )
              ?.slice(0, 5)
