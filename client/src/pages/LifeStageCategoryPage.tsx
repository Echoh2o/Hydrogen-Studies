    ...
    const fetchStudies = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/consumer-categories/studies?model=life_stage&category=${encodeURIComponent(displayName)}`,
        );
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <Helmet>
        ...
        <meta
          property="og:title"
          content={`Hydrogen Therapy Research for ${displayName} | Age-Specific Studies`}
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content={`${displayName} Hydrogen Therapy Research | Age-Specific Benefits`}
        />
        <meta
          name="twitter:description"
          content={`Scientific studies on hydrogen therapy benefits for ${displayName.toLowerCase()}. Age-appropriate research database.`}
        />
        ...
        <>
          ...
          <div className="mt-16 p-6 bg-neutral-50 rounded-lg border border-neutral-200">
            ...
            <p className="text-neutral-600 mb-4">
              Research on hydrogen therapy for {displayName.toLowerCase()}{" "}
              explores how molecular hydrogen's potential benefits may be
              particularly relevant to this demographic. Studies investigate
