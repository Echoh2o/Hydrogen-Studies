...
export default function SemanticScholarPage() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest(
        "GET",
        `/api/semanticscholar/search?query=${encodeURIComponent(activeQuery)}&page=${page}&pageSize=${pageSize}`,
      );
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest(
        "GET",
        `/api/semanticscholar/paper/${selectedPaper.paperId}`,
      );
      return response.json();
    },
  ...
  const importPaperMutation = useMutation({
    mutationFn: async (paperId: string) => {
      const response = await apiRequest("POST", "/api/semanticscholar/import", {
        id: paperId,
      });
      return response.json();
    },
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          Search and import hydrogen research papers from Semantic Scholar's
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter keywords to search for relevant hydrogen research papers. The
            search will automatically include hydrogen-related terms if not
            specified.
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            {isSearching ? (
              ...
              <Table>
                <TableCaption>
                  Hydrogen research papers from Semantic Scholar
                </TableCaption>
                <TableHeader>
                  <TableRow>
      ...
      <AlertDialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              The paper has been added to your hydrogen studies database and is
