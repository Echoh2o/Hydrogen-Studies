        ...
        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {activeTab === "url" &&
                  "Import a study by pasting its URL from any supported platform"}
                {activeTab === "pubmed" &&
                  "Search and import studies from PubMed database"}
                {activeTab === "europepmc" &&
                  "Search and import studies from Europe PMC database"}
                {activeTab === "crossref" &&
                  "Search and import studies from CrossRef database"}
                {activeTab === "semanticscholar" &&
                  "Search and import studies from Semantic Scholar database"}
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Biomedical literature, citations, abstracts
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h4 className="font-medium">Europe PMC</h4>
              <p className="text-sm text-muted-foreground">
                Life sciences research and literature
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h4 className="font-medium">CrossRef</h4>
              <p className="text-sm text-muted-foreground">
                DOI-registered academic publications
              </p>
            </div>
            <div className="p-4 border rounded-lg">
              <h4 className="font-medium">Semantic Scholar</h4>
              <p className="text-sm text-muted-foreground">
                AI-powered scientific research papers
              </p>
            </div>
            <div className="p-4 border rounded-lg">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Pre-print archive for scientific papers
              </p>
            </div>
          </div>
        </div>
