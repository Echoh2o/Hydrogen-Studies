  ...
  const startScraperMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast({
        ...
        description:
          "The hydrogen studies scraper has been started successfully",
      });
    ...
    onError: (error) => {
      toast({
        ...
        description:
          error.message || "An error occurred while starting the scraper",
        variant: "destructive",
      });
    },
  });
      ...
      <div className="space-y-6">
        ...
        <div className="bg-muted p-4 rounded-lg">
          ...
          <p className="text-sm mb-3">
            Your Excel file should contain columns that match our database
            structure. The system supports specific column names from your
            Hydrogen Research Database format.
          </p>
          <div className="text-xs space-y-1">
            <p>
              <strong>Required columns:</strong> Title, Abstract, Authors/First
              Author, Journal, Publish Date/Year
            </p>
            <p>
              <strong>Optional columns:</strong> Primary Topic, Secondary Topic,
              Model, Category, Methods, Results, Conclusion, DOI, PDF URL, Peer
              Reviewed, Country, Region, Study Type, Sample Size, Duration,
              ...
              <div className="text-left flex items-center">
                ...
                <div>
                  <div className="font-medium">
                    Run Hydrogen Studies Scraper
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Automatically discover and import studies from
                    hydrogenstudies.com
                  </div>
                </div>
              </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <div className="text-sm">
                    {scraperStatus.status.current?.currentStep ||
                      "Processing..."}
                    <div className="mt-2 text-xs">
                      Processed:{" "}
                      {scraperStatus.status.current?.processedItems || 0} /
