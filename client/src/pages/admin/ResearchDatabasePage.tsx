            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium mb-2">
                  Scheduled Searches Coming Soon
                </h3>
                <p className="text-muted-foreground max-w-md mx-auto">
                  This feature will allow you to schedule regular automated
                  searches across multiple databases for hydrogen research.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="imported">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and manage studies recently imported from research
                databases
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell className="font-medium">
                        Hydrogen-rich saline alleviates early brain injury via
                        reducing oxidative stress and brain edema
                      </TableCell>
                    ...
                    <TableRow>
                      <TableCell className="font-medium">
                        Hydrogen as a novel therapeutic agent in Cerebral
                        Vascular Disease
                      </TableCell>
                ...
                <div className="mt-6 border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Enhance existing studies by pulling in missing data from all
