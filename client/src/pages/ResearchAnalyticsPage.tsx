                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="text-2xl font-bold text-purple-600">
                          {citationData && typeof citationData === 'object' && 'totalConnections' in (citationData as any) && typeof (citationData as any).totalConnections === 'number' ? (citationData as any).totalConnections.toLocaleString() : "2,450+"}
                        </div>
                        <p className="text-sm text-gray-600">
