...
export default function EnhancedStudyPage() {
  ...
  const recordView = useMutation({
    mutationFn: async () => {
      const response = await fetch(`/api/studies/${studyId}/view`, {
        method: "POST",
      });
      ...
      <div className="container mx-auto px-4 py-8">
              ...
              {study.tags && study.tags.length > 0 ? (
                study.tags.map((tag) => (
                  ...
                  >
                    {tag.name}
                    <span
                      className={`ml-1 ${getConfidenceColor(tag.confidence)}`}
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <CardContent>
                    {study.methods ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">
                        Detailed methodology information available in the
                ...
                <Card>
                  ...
                  <CardContent>
                    {study.results ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">
                        Detailed results and statistical analysis available in
              ...
              <TabsContent value="citations" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Ready-to-use citations for your research
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                        {study.citationInfo?.apa ||
                          `${study.authors} (${new Date(study.publishDate).getFullYear()}). ${study.title}. ${study.journal}.`}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                        {study.citationInfo?.mla ||
                          `${study.authors}. "${study.title}." ${study.journal}, ${new Date(study.publishDate).getFullYear()}.`}
                      </div>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-sm">
                  ...
                  <Badge
                    variant="outline"
                    className={getCategoryColor(study.category)}
                  >
                    {study.category
            ...
            {/* Related Studies */}
            {recommendations?.similarStudies &&
              recommendations.similarStudies.length > 0 && (
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                          ...
                          <div key={relatedStudy.id} className="space-y-1">
                            ...
                            <div className="flex items-center justify-between text-xs">
                              ...
                              <Badge variant="outline" className="text-xs">
                                {Math.round(relatedStudy.relevanceScore * 100)}%
                                match
                              </Badge>
                            </div>
                          </div>
            ...
            {recommendations?.trendingInCategory &&
              recommendations.trendingInCategory.length > 0 && (
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
