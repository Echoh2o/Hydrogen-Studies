  ...
  return (
    <>
      ...
      <div className="container mx-auto py-10">
        <Helmet>
          <title>
            Explore Hydrogen Studies by Demographic | HydrogenStudies.com
          </title>
          <meta
            name="description"
        ...
        <div className="space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Find hydrogen research studies organized by the specific
          ...
          {demographicsLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {demographics?.map((demographic: any) => (
                <Link
                  key={demographic.id}
                  href={`/demographics/${demographic.slug}`}
                >
    ...
    <div className="container mx-auto py-10">
      {isLoading ? (
        ...
        <>
          <Helmet>
            <title>
              {demographic?.name} | Hydrogen Research | HydrogenStudies.com
            </title>
            <meta
              name="description"
              content={`Explore hydrogen research studies involving ${demographic?.name.toLowerCase()} - ${demographic?.description}`}
            />
          </Helmet>
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-4">
              Research involving {demographic?.name}
            </h2>
                ...
                <div className="space-y-4">
                  {studies.length > 0 ? (
                    ...
                    <div className="text-center py-10">
                      <p className="text-muted-foreground">
                        No studies found for this demographic.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <TabsContent value="clinical">
                <div className="space-y-4">
                  ...
                  0 ? (
                    ...
                    <div className="text-center py-10">
                      <p className="text-muted-foreground">
                        No clinical studies found for this demographic.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <TabsContent value="preclinical">
                <div className="space-y-4">
                  {studies.filter(
                    ...
                    <div className="text-center py-10">
                      <p className="text-muted-foreground">
                        No preclinical studies found for this demographic.
                      </p>
                    </div>
                  )}
                </div>
