        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-lg text-muted-foreground max-w-3xl">
              ...
              Our AI-powered search understands your intent and finds the most relevant studies.
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={() => {
                toast({
                  title: "Help",
                  description: "Try asking questions like: 'Studies for arthritis in elderly patients' or 'Compare hydrogen water vs inhalation'",
                });
              }}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  This search uses OpenAI to understand your questions, extract key concepts, 
                  and find semantically similar research. Try asking complex questions or making comparisons!
                </p>
        ...
        >
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Our AI understands medical terminology, abbreviations, and complex queries. 
                It expands H2 to hydrogen, recognizes conditions, and understands research context.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Automatically extracts filters from your query. Mention age groups, 
                conditions, or time periods, and we'll apply the right filters.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                See why each result matches your query. We explain our understanding 
                and show relevance scores for complete transparency.
              </p>
            </CardContent>
          </Card>
        </motion.div>
