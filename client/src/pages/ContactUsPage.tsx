          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    How do I search for specific studies?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    Use our advanced search feature to filter by condition,
                    study type, publication date, and keywords. You can also
                    browse by categories or use our AI assistant for
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    Are all studies peer-reviewed?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    Yes, we only include peer-reviewed studies from reputable
                    scientific journals. 96% of our studies include DOI links
                    for verification and direct access to the original research.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    Can I submit studies for inclusion?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    We welcome study submissions from researchers and
                    institutions. Please contact us with the study details, and
                    our team will review it for inclusion based on our quality
                    criteria.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600">
                    No, we provide educational information based on scientific
                    research. Always consult with qualified healthcare
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600 mb-4">
                    For urgent research inquiries or time-sensitive projects,
                    please mark your message as "URGENT" and we'll prioritize
                    your request.
                  </p>
