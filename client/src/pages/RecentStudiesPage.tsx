  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Browse the latest research studies on hydrogen gas and its health applications. Discover new findings in hydrogen therapy research." />
      </Helmet>
      
      <section className="bg-primary-gradient text-white py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-center">Recent Hydrogen Studies</h1>
