  ...
  const benefitCategories = [
    {
      ...
      studyCount: 127,
      description: 'Research shows hydrogen water may support cardiovascular function and reduce oxidative stress.',
      benefits: [
    ...
    },
    {
      ...
      studyCount: 89,
      description: 'Studies indicate potential cognitive benefits and neuroprotective effects.',
      benefits: [
    ...
    },
    {
      ...
      studyCount: 203,
      description: 'Hydrogen acts as a selective antioxidant, targeting harmful free radicals.',
      benefits: [
    ...
    },
    {
      ...
      studyCount: 64,
      description: 'Athletes report improved performance and faster recovery times.',
      benefits: [
              ...
              {researchHighlights.map((stat, index) => (
                <Card key={index} className="text-center border-none shadow-lg">
                  <CardContent className="p-4">
                    <div className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">{stat.stat}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card className="mb-16">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl mb-4">How Hydrogen Water Works</CardTitle>
            <CardDescription className="text-lg max-w-3xl mx-auto">
              Understanding the science behind molecular hydrogen's potential health benefits.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Selective Antioxidant</h3>
                <p className="text-gray-600">
                  Hydrogen selectively neutralizes harmful hydroxyl radicals while preserving beneficial reactive oxygen species.
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Cellular Protection</h3>
                <p className="text-gray-600">
                  Small molecular size allows hydrogen to penetrate cell membranes and protect cellular structures.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Research suggests hydrogen may help modulate inflammatory responses in various body systems.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Explore our research-backed product recommendations and start your hydrogen water journey today.
            </p>
        ...
        <div className="mt-12 p-6 bg-gray-100 rounded-lg">
          <p className="text-sm text-gray-600 text-center">
            <strong>Important:</strong> The information presented here is based on scientific research and is for educational purposes only. 
            This content is not intended to diagnose, treat, cure, or prevent any disease. Individual results may vary. 
