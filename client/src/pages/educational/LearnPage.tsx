...
import { Book, BookOpenText, FileText, HelpCircle, Lightbulb } from 'lucide-react';
  ...
  return (
    <ResponsiveContainer>
      <Helmet>
        ...
        <meta name="description" content="Educational resources to help you understand hydrogen therapy research, including glossary of terms, FAQ, and tutorials on how to read scientific studies." />
      </Helmet>
      
      <div className="py-6 md:py-10">
        <h1 className={`${getResponsiveFontSize('heading1')} text-center text-gradient-primary mb-4`}>
          Learn About Hydrogen Research
        </h1>
        
        <p className="text-lg text-center text-muted-foreground max-w-3xl mx-auto mb-8">
          Resources to help you understand hydrogen therapy research, the science behind it, and how to interpret scientific studies.
        </p>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>
                    Understand how to interpret scientific studies on hydrogen therapy
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">Learn how to navigate scientific papers, understand key sections, and evaluate the quality of research.</p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>
                    Definitions of common scientific terms found in hydrogen research
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">From "oxidative stress" to "molecular hydrogen" — understand the key terminology used in studies.</p>
                  <Button asChild className="w-full">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="mb-4">Get answers to common questions about hydrogen therapy, its effects, and the current state of research.</p>
                  <Button asChild className="w-full">
            ...
            {/* Featured Tutorials */}
            <div className="mt-12">
              <h2 className={`${getResponsiveFontSize('heading2')} mb-6`}>Featured Tutorials</h2>
              <ResponsiveGrid mobileColumns={1} tabletColumns={2} desktopColumns={3} gap="medium">
                {isLoading ? (
                  <p>Loading tutorials...</p>
                ) : (
                  resources
                    ?.filter(resource => resource.resourceType === 'tutorial' && resource.isPublished)
                    .slice(0, 3)
                    .map(tutorial => (
                      <Card key={tutorial.id} className="hover:shadow-lg transition-shadow">
                        ...
                        <CardContent>
                          <p className="line-clamp-3 mb-4">{tutorial.content.substring(0, 100)}...</p>
                          <Button asChild variant="outline" className="w-full">
                            <Link to={`/learn/tutorials/${tutorial.slug}`}>Read Tutorial</Link>
                          </Button>
                        </CardContent>
                      </Card>
                    ))
                    ...
                    {faqItems.length > 0 ? (
                      Object.entries(
                        ...
                        <div key={category} className="mb-8">
                          <h3 className="text-xl font-bold mb-4 capitalize">{category} Questions</h3>
                          <div className="space-y-4">
                            {items
