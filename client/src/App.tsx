...
export default App;
```/**
 * This file defines the main application router and global error handling.
 * It configures routes, analytics, and global error handling for promise rejections.
 */
import { Switch, Route, useLocation } from "wouter";
import { queryClient } from "./lib/queryClient";
import { QueryClientProvider } from "@tanstack/react-query";
