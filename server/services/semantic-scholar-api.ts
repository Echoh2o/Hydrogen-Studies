 ...
 */
export async function getSemanticScholarArticleByDOI(
  doi: string,
): Promise<any> {
    ...
    const response = await axios.get(
      "https://api.semanticscholar.org/graph/v1/paper/search",
      {
        params: {
          ...
          offset,
          fields:
            "title,abstract,url,journal,year,authors,venue,publicationDate,externalIds,isOpenAccess",
        },
        headers: {},
        timeout: 10000,
      },
 ...
 */
export function extractStudyFromSemanticScholar(
  paperData: any,
): InsertStudy | null {
