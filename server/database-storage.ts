...
class MemoryFallback {
  ...
  private userStudyInteractionsData: Map<string, UserStudyInteraction> =
    new Map();
  private userBlogInteractionsData: Map<string, UserBlogInteraction> =
    new Map();
...
export class DatabaseStorage implements IStorage {
  ...
  constructor() {
    ...
    console.log(
      "DatabaseStorage initialized with database adapter and memory fallbacks",
    );
  }
