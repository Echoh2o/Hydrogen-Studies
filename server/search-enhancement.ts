...
const SEMANTIC_GROUPS = {
  cardiovascular: ['heart', 'cardiac', 'cardio', 'myocardial', 'coronary', 'vascular', 'blood pressure', 'hypertension', 'circulation'],
  inflammation: ['inflammatory', 'anti-inflammatory', 'cytokine', 'immune', 'arthritis', 'rheumatoid'],
  oxidative: ['antioxidant', 'free radicals', 'reactive oxygen', 'ROS', 'oxidative damage', 'cellular protection'],
  neurological: ['brain', 'neural', 'cognitive', 'memory', 'alzheimer', 'parkinson', 'neurodegenerative'],
  metabolic: ['metabolism', 'diabetes', 'glucose', 'insulin', 'obesity', 'metabolic syndrome'],
