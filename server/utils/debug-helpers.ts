...
export function validateStudyData(data: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
...
export function validateDatabaseResult(result: any, expectedFields: string[]): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
